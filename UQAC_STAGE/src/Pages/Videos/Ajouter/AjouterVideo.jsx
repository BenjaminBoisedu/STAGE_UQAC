...
export default function AjouterVideo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addDoc(collection(db, "Vidéo"), {
        titre,
        description,
        lien,
  ...
  return (
    <main className="ajouter-video-scroll-zone">
      <div className="ajouter-video-content">
        <h2>Ajouter une vidéo</h2>
        <form onSubmit={handleSubmit} className="ajouter-video-form">
          <label>Titre</label>
          <input
            type="text"
            value={titre}
